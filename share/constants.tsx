        ...
        option: [
          {
            ...
            option_content: [
              { content_title: 'Size S', price: 0, field: 'sizeS' },
              { content_title: 'Size M', price: 0.2, field: 'sizeM' },
              { content_title: 'Size L', price: 0.5, field: 'sizeL' },
            ],
          },
          {
            option_title: 'TOPPING',
            option_content: [
              { content_title: 'Calories', price: 1, field: 'calories' },
              { content_title: 'Caffeine', price: 1, field: 'faffeine' },
            ],
          },
          {
            option_title: 'choose the amount of sugar',
            option_content: [
              { content_title: '100% sugar', price: 0, field: 'sugar100' },
              { content_title: '70% sugar', price: 0, field: 'sugar70' },
              { content_title: '50% sugar', price: 0, field: 'sugar50' },
              { content_title: '30% sugar', price: 0, field: 'sugar30' },
              { content_title: 'no sugar', price: 0, field: 'sugar0' },
            ],
          },
        ],
      },
